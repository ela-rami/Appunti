document.addEventListener('DOMContentLoaded', function () {
    ...
    // NOTA: La logica per il bottone "Appunti Prof (PDF)" è stata rimossa
    // dato che non è previsto per le lezioni di Reti.
    // Se in futuro servisse, andrebbe aggiunta qui verificando l'esistenza
    // del bottone e dell'attributo data-pdf-path.
});